...
async function consultar(consulta,inicio,tamanho){const u=new URL('/api/google-books',location.origin);u.searchParams.set('q',consulta);u.searchParams.set('startIndex',String(inicio));u.searchParams.set('maxResults',String(tamanho));return obterJSON(u,18000,1)}
